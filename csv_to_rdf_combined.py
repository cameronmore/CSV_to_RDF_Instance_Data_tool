        ...
        with open(mapping_file, 'r') as input_file:
            ...
            for mapping_row in mapping_reader:
                ...
                if mapping_row['p'] == 'RDF.type' :
                    g.add((URIRef(mapping_row['s']+uuid),RDF.type,mapping_row['o']))
                    g.add((URIRef(mapping_row['s']+uuid),RDF.type,owl:NamedIdividual))
                ...
                if mapping_row['p'] != 'RDF.type' :
                    if 'datapoint' in mapping_row['o']:
                        ...
                        g.add((URIRef(mapping_row['s']+uuid_str),RDF.type,Literal(row[split_datapoint_list[2]],datatype=XSD.split_datapoint_list[1] )  ))
